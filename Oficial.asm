.data
	...
	myFile: .asciiz "C://Users//Cloja//Documents//ESPOL//6S//organizacion//proyecto//TablaIni.txt"     
	#myFile: .asciiz "C:/Users/Alexis/Desktop/ESPOL/4to Semestre/Organización de computadoras/Proyecto/organization_project/TablaIni.txt" # filename for input
	buffer: .space 1000
	...
	opc3: .asciiz "3. Mostrar top 3 \n"
	opc4: .asciiz "4. Salir\n"
	ing: .asciiz "ingrese un numero: \n"
	errorDeNumero: .asciiz "ingrese solo una de las 3 opciones \n\n"
	errorIngreso: .asciiz "Ingreso una letra, por favor vuelva a ingresar \n" 
	print_ne1: .asciiz "Ingrese Nombre de equipo 1: "
	print_ge1: .asciiz "Ingrese Goles de equipo 1: "
	
	print_ne2: .asciiz "Ingrese Nombre de equipo 2: "
	print_ge2: .asciiz "Ingrese Goles de equipo 2: "
	...
	errorNombre: .asciiz "Ingreso un nombre que no existe"
...
menu: 
		...
		la $a1, 99
		syscall
		move $s1, $a0 #respaldo del valor ingresado
		
		jal borrarEnter #se borra el enter
		li $a0, 0
		move $a1,$v0
		li $a2,0
		jal isdigit
	...
	ingrPart:
		...
		lw $a1, ($sp)
		jal find_index_number #Encontrar la posicion de la fila a ingresar
		sw $v0,($sp) # Numero del indice 1 ordenado (Fila)
		
		la $a0,lista_indices
		lw $a1, 8($sp)
		jal find_index_number #Encontrar la posicion de la fila a ingresar
		sw $v0,8($sp) # Numero del indice 2 ordenado (Fila)
